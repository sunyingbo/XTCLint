package com.xtc.lint.rules.detectors.xml;
 ...
 */
public class XTCViewIdNameDetector extends ResourceXmlDetector {
    private static final Class<? extends Detector> DETECTOR_CLASS = XTCViewIdNameDetector.class;
